...
export const stories: Story[] = [
    ...
    locations: [
      {
        ...
        name: 'Murder of Mollie Smith',
        subtitle: 'The first blood drawn on New Year\'s Eve',
      ...
      },
      {
        ...
        name: 'The Christmas Eve Double Murder',
        subtitle: 'The panic peaks as two wealthy women are targeted',
      ...
      },
      {
        ...
        name: 'The Moonlight Tower',
        subtitle: 'A solution born of terror',
        description: 'In 1894, the city purchased 31 165-foot towers to illuminate the streets and deny the "Annihilator" the cover of darkness. While the murders had stopped years earlier, the trauma remained. Austin is now the only city in the world that still operates these towers, a haunting architectural legacy of a 19th-century serial killer.',
        lat: 30.2713,
        lng: -97.7461,
        type: 'landmark',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        subtitle: 'Where the "secret" move began in the dead of night',
      ...
      },
      {
        ...
        name: 'Eberly\'s Cannon',
        subtitle: 'A single shot that saved the capital',
    ...
    locations: [
      {
        ...
        subtitle: 'Voted "Ugliest Man" by a fraternity prank',
      ...
      },
      {
        ...
        name: 'Threadgill\'s',
        subtitle: 'The first female rock and roll superstar\'s first stage',
      ...
      },
      {
        ...
        subtitle: 'The "Ghetto Mansion" of the 60s counterculture',
    ...
    locations: [
      {
        ...
        name: 'Wooldridge Square Benefit',
        subtitle: 'Where the Armadillo logo was born',
      ...
      },
      {
        ...
        name: 'The Armadillo Venue',
        subtitle: 'Where hippies and rednecks finally got along',
        description: 'Opened in 1970 in an old armory, the venue became a cultural phenomenon. It was the only place where you could see Frank Zappa, AC/DC, and Willie Nelson in the same room. The venue\'s closure in 1980 to make way for a high-rise office building is often cited as the moment "Old Austin" began its slow decline into commercialization.',
        lat: 30.2581,
        lng: -97.7498,
        type: 'cultural_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        subtitle: 'A lethal dose of Velpar under the moon',
      ...
      {
        id: 'treaty-oak-lab',
        name: 'Texas A&M Forestry Lab',
        subtitle: 'Forensic evidence of a dendrological murder',
    ...
    locations: [
      {
        id: 'plan-city-hall',
        name: 'Old City Hall',
        subtitle: 'Where the 1928 Master Plan was codified into law',
        description: 'The Austin City Council formally adopted the plan created by Koch & Fowler, which recommended the creation of a \'Negro District.\' By concentrating all schools and services for Black residents in East Austin, the city found a way to enforce segregation without technically passing illegal racial zoning laws.',
        lat: 30.2700,
        lng: -97.7420,
        type: 'government',
        importance: 'major' as const,
      ...
      {
        id: 'plan-east-avenue',
        name: 'East Avenue Boundary',
        subtitle: 'The physical line where the city cut off services',
      ...
      },
      {
        ...
        name: 'Wheatville School',
        subtitle: 'The closure of a community anchor',
    ...
    locations: [
      {
        ...
        subtitle: 'The site of the official refusal by Governor Colquitt',
      ...
      },
      {
        ...
        subtitle: '5,000 people gather at a former landfill to hear the truth',
    ...
    locations: [
      {
        ...
        name: 'The Power House Explosion',
        subtitle: 'Where the dam breached and eight workers died',
      ...
      },
      {
        id: 'dam-red-bud-isle',
        name: 'Red Bud Isle',
        subtitle: 'Massive chunks of the original dam still sit in the river',
    ...
    locations: [
      {
        ...
        subtitle: 'The scene of the $854.08 shortage',
      ...
      },
      {
        ...
        subtitle: 'Where William Sydney Porter became \'O. Henry\'',
    ...
    locations: [
      {
        ...
        name: 'The Cathedral',
        subtitle: '60 tons of tires, bathtubs, and a Buddha leaf',
        description: 'Vince Hannemann began building the cathedral in 1988. It features vaulted ceilings of bicycle wheels and a "throne" of electronics. The structure includes a leaf from the Buddha\'s tree of enlightenment encased in a specific chamber, making it a bizarre spiritual hub made of recycled waste.',
        lat: 30.2185,
        lng: -97.7715,
        type: 'cultural_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        subtitle: 'The legal battle to save a mountain of trash',
        description: 'In 2010, the city nearly demolished the Cathedral after neighbor complaints. Hannemann mobilized engineers to prove the junk was structurally sound. After a high-stakes hearing and massive public support, the city issued a permit, officially legitimizing the junk as art.',
        lat: 30.2658,
        lng: -97.7492,
        type: 'government',
        importance: 'minor' as const,
  ...
  },
  {
    ...
    locations: [
      {
        id: 'dell-dobie-room',
        name: 'Dobie Center Room 2713',
        subtitle: 'The literal birthplace of PC\'s Limited',
        description: 'While a freshman, Michael Dell began upgrading computers and selling them directly to customers. The fire marshal eventually intervened when Dell had stacked so many cardboard boxes in the hallway that it became a fire hazard, forcing him to move his business off-campus.',
        lat: 30.2851,
        lng: -97.7419,
        type: 'residence',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Braker Lane Office',
        subtitle: 'The first "adult" office where the company nearly died',
        description: 'Following the Dobie Center eviction, Dell moved to this office. The growth was so explosive that the company struggled to manage inventory, nearly collapsing under its own weight before a pivot to custom-built machines saved the future empire.',
        lat: 30.3905,
        lng: -97.7088,
        type: 'industrial_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'Tower Observation Deck',
        subtitle: 'Where Charles Whitman held the campus hostage',
        description: 'Whitman reached the 28th floor with a footlocker of rifles. From the 231-foot vantage point, he began picking off students and faculty below. The observation deck was eventually breached by Officers Ramiro Martinez and Houston McCoy, who ended the siege.',
        lat: 30.2862,
        lng: -97.7394,
        type: 'crime_scene',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'The Main Mall',
        subtitle: 'The "dead zone" where civilians fired back',
        description: 'The mall south of the tower was a killing field. Realizing the police were outgunned, local Austin citizens grabbed deer rifles from their trucks and began firing back at the tower. This improvised civilian response pinned Whitman down and prevented a higher death toll.',
        lat: 30.2855,
        lng: -97.7394,
        type: 'battlefield',
        importance: 'major' as const,
  ...
  },
  {
    ...
    locations: [
      {
        id: 'srv-antones-6th',
        name: 'Antone\'s (Original)',
        subtitle: 'Where a teenage Stevie sat at the feet of Muddy Waters',
        description: 'Clifford Antone\'s original blues club on 6th Street was Vaughan\'s home. He spent his youth watching legends like Muddy Waters and Albert King, eventually developing the explosive, heavy-stringed style that would change rock history.',
        lat: 30.2671,
        lng: -97.7385,
        type: 'cultural_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        subtitle: 'The permanent pilgrimage site for guitarists',
        description: 'The bronze statue at Auditorium Shores commemorates Vaughan\'s legacy. Fans from around the world leave flowers at his feet, and the statue is a central point for Austin music pilgrimages, standing near the site of many of his most famous performances.',
        lat: 30.2633,
        lng: -97.7485,
        type: 'landmark',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        subtitle: '1.5 million residents who eat 20,000 lbs of bugs a night',
        description: 'The bridge\'s 18-inch-deep crevices are the perfect temperature for Mexican free-tailed bats. In the early 80s, residents called for their extermination until Dr. Merlin Tuttle of Bat Conservation International moved to Austin to save the colony, proving they were a massive benefit to the city.',
        lat: 30.2619,
        lng: -97.7441,
        type: 'natural_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        subtitle: 'The 68-degree heart of Austin environmentalism',
        description: 'The natural springs were the catalyst for Austin\'s modern environmental laws. The springs are home to the endangered Barton Springs Salamander, which became the legal centerpiece of the fight to stop the Barton Creek PUD development.',
        lat: 30.2636,
        lng: -97.7712,
        type: 'natural_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Old City Hall',
        subtitle: 'The 15-hour "All-Night Public Hearing"',
        description: 'On June 7, 1990, a record-breaking crowd flooded the council chamber. Residents spoke until the sun rose, successfully pressuring the city to reject the massive development plan. This event remains the benchmark for political activism in Austin.',
        lat: 30.2700,
        lng: -97.7420,
        type: 'government',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'Driskill Hotel Lobby',
        subtitle: 'Where LBJ had his first date with Lady Bird',
        description: 'In 1934, LBJ met Claudia \'Lady Bird\' Taylor for breakfast at the Driskill. He proposed shortly after. The hotel remained his political HQ throughout his career, including the night he watched the returns of his 1948 Senate race.',
        lat: 30.2681,
        lng: -97.7416,
        type: 'landmark',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Lady Bird Lake',
        subtitle: 'A beautification project that replaced trash with trails',
        description: 'In the 1970s, Lady Bird led a massive project to clean up the banks of Town Lake. Her influence replaced trash-strewn banks with thousands of flowering trees and the hike-and-bike trails that define downtown Austin today.',
        lat: 30.2588,
        lng: -97.7413,
        type: 'natural_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'The Driskill Lobby',
        subtitle: 'Jesse Driskill loses a $400,000 hotel in a poker game',
        description: 'Just two years after building the finest hotel in Texas, Jesse Driskill, an inveterate gambler, lost the entire building in a high-stakes poker game. He died bankrupt shortly after, and his spirit is said to haunt the halls to this day.',
        lat: 30.2681,
        lng: -97.7416,
        type: 'landmark',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Room 525',
        subtitle: 'The site of the "Suicide Brides"',
        description: 'In Room 525, two separate brides committed suicide in the same bathtub, exactly 20 years apart to the day. The room was sealed for years before being reopened, and remains a central point for reported paranormal activity.',
        lat: 30.2682,
        lng: -97.7415,
        type: 'residence',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'St. Mary\'s Orphan Asylum Site',
        subtitle: 'Where ten nuns and 90 children formed a human chain',
        description: 'As the storm surge breached the dormitory, the Sisters of Charity tied themselves to the children with clotheslines. They sang \'Queen of the Waves\' to calm the orphans until the building collapsed. Only three boys survived by clinging to a salt cedar tree. The site is now occupied by a Walmart Supercenter.',
        lat: 29.2729,
        lng: -94.8220,
        type: 'discovery_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        subtitle: 'The only sanctuary for the three boys who escaped',
        description: 'The salt cedar tree located on the orphanage grounds was the only thing that didn\'t wash away. Three orphans\u2014Will Murney, Frank Madera, and Albert Campbell\u2014clung to its branches through the night, witnessing the destruction of the asylum and the loss of their peers and the sisters.',
        lat: 29.2731,
        lng: -94.8214,
        type: 'natural_site',
        importance: 'minor' as const,
    ...
    locations: [
      {
        ...
        name: 'Enron Complex',
        subtitle: 'The headquarters where "Death Star" strategies were born',
        description: 'Traders in the 50-story north tower coordinated artificial power outages in California while mocking "Grandma Millie" on recorded phone lines. The memos found here after the collapse described a sophisticated system of market manipulation that prioritized quarterly earnings over human safety.',
        lat: 29.7561,
        lng: -95.3695,
        type: 'crime_scene',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Tilted "E" Auction Site',
        subtitle: 'Where a symbol of global power was sold to a waste management firm',
        description: 'Following Enron\'s bankruptcy filing, the iconic tilted "E" sign outside the headquarters was sold at auction for $44,000. It served as a visceral visual end to the company that once claimed to be "The World\'s Leading Company." The logo was eventually purchased by a local scrap and waste company.',
        lat: 29.7565,
        lng: -95.3698,
        type: 'landmark',
        importance: 'minor' as const,
    ...
    locations: [
      {
        ...
        subtitle: 'The windowless room where the "Mail Slot" fix was designed',
        description: 'On April 13, 1970, the words "Houston, we\'ve had a problem" echoed through this room. Engineers here worked for three days straight, building the prototype for the CO2 scrubber adapter using only a plastic bag, cardboard, and duct tape to match the items the astronauts had on board.',
        lat: 29.5581,
        lng: -95.0897,
        type: 'institution',
        importance: 'major' as const,
      ...
      {
        id: 'apollo-lunar-lab',
        name: 'Lunar Module Simulation Lab',
        subtitle: 'Where the power-up sequence was calculated',
        description: 'Because the Lunar Module was never meant to be a long-term lifeboat, engineers in this facility had to rewrite the spacecraft\'s entire operating manual in real-time. They calculated exactly how much battery power could be diverted to the heating systems without killing the crew\'s re-entry guidance.',
        lat: 29.5595,
        lng: -95.0912,
        type: 'discovery_site',
        importance: 'minor' as const,
    ...
    locations: [
      {
        ...
        name: 'The Balinese Room',
        subtitle: 'A pier-based casino that outran the Texas Rangers',
        description: 'The Balinese Room was built on a 600-foot pier over the Gulf. Whenever the Texas Rangers raided, they had to walk the entire length of the pier. By the time they reached the casino floor, the staff had pushed buttons to flip gambling tables into ordinary buffets and hide the bands\' instruments.',
        lat: 29.2847,
        lng: -94.7865,
        type: 'crime_scene',
        importance: 'major' as const,
      ...
      {
        id: 'free-maceo-hq',
        name: 'The Maceo Headquarters',
        subtitle: 'Where the "Free State" was managed by the mob',
        description: 'Sam and Rosario Maceo managed their empire from this location. Their influence was so absolute that the city\'s police chief and local government were openly on their payroll. The "Free State" provided a Depression-era economic boom that the rest of Texas lacked.',
        lat: 29.3031,
        lng: -94.7932,
        type: 'government',
        importance: 'minor' as const,
    ...
    locations: [
      {
        ...
        name: 'Pier O',
        subtitle: 'Where the SS Grandcamp detonated',
        description: 'On April 16, 1947, a fire broke out on the SS Grandcamp, carrying 2,300 tons of ammonium nitrate. A crowd gathered to watch the orange smoke, unaware that a massive detonation was imminent. The blast leveled the nearby Monsanto plant and killed over 500 people instantly.',
        lat: 29.3752,
        lng: -94.8875,
        type: 'crash_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'The Two-Ton Anchor',
        subtitle: 'Launched 1.6 miles by the force of the blast',
        description: 'This specific two-ton anchor was found embedded in the mud over a mile away from the explosion site. It stands today exactly where it landed, a visceral marker of the pressure wave that shattered windows 40 miles away in Houston.',
        lat: 29.3874,
        lng: -94.9036,
        type: 'discovery_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'Marfa Lights Observation Area',
        subtitle: 'Where rancher Robert Reed Ellison first recorded the orbs',
        description: 'Ellison reported the lights while driving a herd of cattle in 1883, initially fearing they were Apache signal fires. Today, the state-funded viewing area attracts thousands who witness the lights darting across the horizon in areas where no roads or power lines exist.',
        lat: 30.2713,
        lng: -103.8825,
        type: 'natural_site',
        importance: 'major' as const,
    ...
    locations: [
      {
        ...
        name: 'Lajitas Trading Post',
        subtitle: 'Where Clay Henry I held court and drank longnecks',
        description: 'The original Mayor, Clay Henry, was a local celebrity who won a mock election in 1986. He became a global news sensation for his ability to drink an entire bottle of beer in seconds. The trading post served as his "office" for years.',
        lat: 29.2662,
        lng: -103.7725,
        type: 'cultural_site',
        importance: 'major' as const,
      ...
      },
      {
        ...
        name: 'Clay Henry III Monument',
        subtitle: 'The memorial to a castrated political leader',
        description: 'In 2002, the mayor\'s successor, Clay Henry III, was at the center of a legal scandal when a man was arrested for "castrating the mayor" in a drunken rage. A bronze statue now stands in Lajitas to commemorate the animal mayors of the Big Bend.',
        lat: 29.2670,
        lng: -103.7718,
        type: 'landmark',
        importance: 'minor' as const,
  ...
  },
  {
    ...
    locations: [
      ...
      {
        id: 'tun-la-posada',
        name: 'La Posada Hotel Basements',
  ...
  },
  {
    ...
    locations: [
      ...
      {
        id: 'palo-tule-canyon',
        name: 'Tule Canyon Horse Slaughter',
    ...
    locations: [
      {
        ...
        name: 'McLennan County Courthouse',
  ...
  },
  {
    ...
    locations: [
      {
        id: 'ww-fault-line',
        name: 'The Balcones Fault Fissure',
