...
export const collections: StoryCollection[] = [
  ...
  {
    id: 'along-shoal-creek',
    name: 'Along Shoal Creek: Austin\'s First Frontier',
    subtitle: 'Bridges, generals, and synagogues — the creek that shaped Austin\'s west side',
    description: 'A walking tour of historic sites along the Shoal Creek watershed, from Austin\'s first bridge to the homes and schools that lined its banks.',
    icon: '🌊',
    momentIds: [
      // On or immediately adjacent to Shoal Creek
      'first-bridge-austin-1865',
      'west-6th-bridge-built-1887',
      'house-park-donation-1903',
      'neill-cochran-custer-hq-1865',
      'beth-israel-congregation-1876',
      'pease-elementary-school-1876',
    ],
    tags: ['austin', 'shoal-creek', 'walking-tour', 'historic-landmarks', 'west-austin'],
  },
  {
    id: 'german-texan-austin',
    name: 'German Austin: Breweries, Bakeries, and the Founders You Never Heard Of',
    subtitle: 'The German immigrants who built Austin\'s commercial backbone from the 1850s to the 1900s',
    description: 'From Scholz Garden to the first chartered school, German immigrants shaped Austin\'s downtown more than any other group.',
    icon: '🍺',
    momentIds: [
    ...
    tags: ['austin', 'german-immigration', 'downtown', 'historic-buildings', 'commerce'],
  },
  {
    id: 'austin-civil-rights-trail',
    name: 'Austin\'s Long Road to Integration',
    subtitle: 'From basement law schools to swim-ins — the places where Austin confronted Jim Crow',
    description: 'The sites where Austin\'s civil rights battles were fought, from Sweatt v. Painter to the desegregation of Barton Springs.',
    icon: '✊',
    momentIds: [
      'carver-library-colored-branch-1926',
      'sweatt-applies-ut-law-1946',
      'sweatt-basement-school-1947',
      'ut-stand-ins-movie-theaters-1960',
  ...
  {
    id: 'austin-natural-swimming',
    name: 'Austin\'s Natural Swimming Holes',
    subtitle: 'Spring-fed pools, collapsed caves, and river eddies — where Austinites have cooled off for over a century',
    description: 'The geology and history behind Austin\'s famous natural swimming spots.',
    icon: '🏊',
    momentIds: [
      'deep-eddy-pool-1902',
  ...
  {
    id: 'servant-girl-annihilator-trail',
    name: 'The Servant Girl Annihilator Trail',
    subtitle: 'Austin\'s first serial killer stalked the city for a year — then vanished. The moonlight towers they built to stop him are still standing.',
    description: 'Between December 1884 and December 1885, an unknown killer attacked at least eight people in their beds across Austin, Texas. The city\'s response was to erect 165-foot moonlight towers that still illuminate downtown today. The killer was never caught.',
    icon: '🔪',
    momentIds: [
      'annihilator-mollie-smith', 'annihilator-eliza-shelley', 'annihilator-irene-cross',
      'annihilator-fourth-victim', 'annihilator-gracie-vance', 'annihilator-eula-phillips',
      'annihilator-christmas-massacre', 'annihilator-o-henry-letter', 'annihilator-moonlight-tower',
      'annihilator-scoot-inn-attack',
    ],
    tags: ['austin', 'serial-killer', 'dark-history', 'true-crime', 'moonlight-towers', '1880s'],
  },
  {
    id: 'austin-music-history',
    name: 'Austin Music History',
    subtitle: 'Janis Joplin sang for a pitcher of beer. George Strait played for gas money. SRV showed up every Wednesday. The venues are still standing.',
    description: 'The honky-tonks, concert halls, and converted gas stations where Austin became the Live Music Capital of the World. Many of these venues still operate today, unchanged.',
    icon: '🎸',
    momentIds: [
      'continental-club-opens-1955', 'threadgills-first-license', 'threadgills-gulf-station',
      'janis-threadgills', 'janis-ut-campus', 'janis-pink-palace', 'janis-joplin-vulcan-gas', 'janis-joplin-residence',
      'srv-antones-6th', 'srv-auditorium-shores',
      'spoke-opening-night', 'spoke-george-strait', 'spoke-survival-battle',
      'armadillo-venue-site', 'armadillo-wooldridge-poster', 'armadillo-willie-1972', 'armadillo-final-concert',
      'acl-pilot-taping-1974', 'acl-studio-6a-landmark-2009',
      'willie-nelson-records-arlyn-austin', 'scholz-opening-1866',
    ],
    tags: ['austin', 'music', 'venues', 'arts-culture', 'live-music-capital'],
  },
  {
    id: 'keep-austin-weird',
    name: 'Keep Austin Weird',
    subtitle: 'A poisoned sacred tree, 165-foot murder-prevention towers, a dorm-room computer empire, and a keg party at the base of a moonlight tower',
    description: 'The moments that made Austin strange: occult tree poisoning, counterculture gatherings, billion-dollar companies born in dorm rooms, and Hollywood filming locations that still look exactly the same.',
    icon: '🤪',
    momentIds: [
      'treaty-oak-site', 'treaty-oak-lab', 'treaty-oak-boundary',
      'annihilator-moonlight-tower',
      'dazed-top-notch', 'dazed-bedichek-middle', 'dazed-moonlight-party',
      'eeyores-birthday-party-1963', 'castle-hill-graffiti-1960s',
      'dell-braker-office', 'dell-dobie-room',
      'junk-cathedral-site',
    ],
  ...
  },
  {
    id: 'haunted-austin',
    name: 'Haunted Austin',
    subtitle: 'A cattle baron who lost his hotel in a poker game still walks the halls. Two brides died in the same bathtub, twenty years apart.',
    description: 'Austin\'s most documented hauntings center on the Driskill Hotel, where cigar smoke appears in empty rooms and guests report a Victorian woman in Room 525. The Annihilator murders left their own kind of haunting — the moonlight towers are monuments to unsolved terror.',
    icon: '👻',
    momentIds: [
      'driskill-poker-loss', 'driskill-room-525',
      'annihilator-moonlight-tower',
