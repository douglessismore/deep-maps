...
export const collections: StoryCollection[] = [
  ...
  },
  {
    id: 'haunted-austin',
    name: 'Haunted Austin',
    subtitle: 'A cattle baron who lost his hotel in a poker game still walks the halls. A child on Fox News says her name is Samantha.',
    description: 'Documented hauntings across downtown Austin, from the Driskill Hotel\'s three resident ghosts to a speakeasy ghost who hides shoes in walls. Every location is visitable. Every ghost has a real historical origin.',
    icon: '👻',
    momentIds: [
